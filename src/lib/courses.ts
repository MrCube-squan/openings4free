...
export const courses: Course[] = [
  ...
  },
  {
    ...
    lines: 40,
    difficulty: 'intermediate',
    description: "Classical development with Nc6 and Nf6. Solid and principled Sicilian play.",
    popularity: 65,
  ...
  },
  {
    ...
    lines: 40,
    difficulty: 'advanced',
    description: "Flexible knight development with ...Nc6 and ...e6. Rich and dynamic.",
    popularity: 70,
