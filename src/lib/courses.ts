...
export const courses: Course[] = [
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'intermediate',
    description: "Pin the knight, skip the theory. Aggressive and underrated.",
    popularity: 60,
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'advanced',
    description: "Fianchetto the bishop, squeeze positionally. The GM weapon.",
    popularity: 82,
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'intermediate',
    description: "Counter-gambit immediately. Reckless, chaotic, and surprisingly tricky.",
    popularity: 35,
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'advanced',
    description: "Ignore the f7 threat. Sacrifice and attack. Pure chaos.",
    popularity: 55,
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'intermediate',
    description: "Sacrifice a pawn for rapid development. A forgotten weapon.",
    popularity: 30,
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'beginner',
    description: "1...e5 against d4. Dubious but full of traps for the unwary.",
    popularity: 40,
    moves: '1.d4 e5',
  },
  {
  ...
  },
  {
    ...
    lines: 1,
    difficulty: 'intermediate',
    description: "Sacrifice two pawns for a devastating attack. Old school aggression.",
    popularity: 48,
